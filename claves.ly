...
claves = \relative {
  ...
  \stopStaff
  %Clave de Fa en 4ta.
  %\override Staff.StaffSymbol.line-positions = #'(-10 -8 -6 -4 -2 0)
  ...
  %\override Staff.StaffSymbol.stencil = #(color-staff-lines #f #f #f #f #f )
  ...
  \stopStaff
  %Clave de Sol en 2da.
  %\override Staff.StaffSymbol.line-positions = #'(0 2 4 6 8 10)
  %\override Staff.StaffSymbol.stencil = #(color-staff-lines red )
